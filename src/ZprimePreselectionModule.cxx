...
ZprimePreselectionModule::ZprimePreselectionModule(uhh2::Context& ctx){
  ...
  if(is2017v2 || is2018){
    ...
    muID  = MuonID(Muon::CutBasedIdMedium);
  }
  if(is2016v2 || is2016v3){
    ...
    muID  = MuonID(Muon::CutBasedIdMedium); // see more muonIDs https://github.com/cms-sw/cmssw/blob/master/DataFormats/MuonReco/interface/Muon.h#L201
  }
