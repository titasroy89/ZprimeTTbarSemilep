...
path_data=/nfs/dust/cms/group/zprime-uhh/Presel_2017/workdir_Zprime_PreSelec_2017_JERdown/ 

mkdir $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2017_common_CHS_JERdown
cd $pathGL_code/ZprimeSemiLeptonic/data/Skimming_datasets_2017_common_CHS_JERdown
